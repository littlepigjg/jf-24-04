...
router.get(
  '/',
  requirePermission('qrcode:view', 'qrcode'),
...
router.get(
  '/:id',
  requirePermission('qrcode:view', 'qrcode', (req) => req.params.id),
  async (req: Request, res: Response): Promise<void> => {
    try {
...
router.post(
  '/',
  requirePermission('qrcode:create', 'qrcode'),
  async (req: Request, res: Response): Promise<void> => {
    try {
...
router.put(
  '/:id',
  requirePermission('qrcode:edit', 'qrcode', (req) => req.params.id),
  async (req: Request, res: Response): Promise<void> => {
    try {
...
router.delete(
  '/:id',
  requirePermission('qrcode:delete', 'qrcode', (req) => req.params.id),
  async (req: Request, res: Response): Promise<void> => {
    try {
